...
module Text.HTML5.MetaData.Schema.Series where
...
--
--   [@subtypes@] @'RadioSeries','TVSeries'@
--
--   [@supertypes@] @'CreativeWork'@
--
--   [@url@] <http://schema.org/Series>
data Series = Series { additionalType :: AdditionalType
...
instance MetaData Series where
  _label         = const "Series"
  _comment_plain = const ""
  _comment       = const ""
  _url           = const "http://schema.org/Series"
  ...
  _subtypes      = const [typeOf (undefined :: Text.HTML5.MetaData.Schema.RadioSeries.RadioSeries), typeOf (undefined :: Text.HTML5.MetaData.Schema.TVSeries.TVSeries)]
