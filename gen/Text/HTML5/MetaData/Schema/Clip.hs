...
import {-# SOURCE #-} qualified Text.HTML5.MetaData.Schema.RadioClip
import {-# SOURCE #-} qualified Text.HTML5.MetaData.Schema.TVClip
...
instance MetaData Clip where
  ...
  _subtypes      = const [typeOf (undefined :: Text.HTML5.MetaData.Schema.RadioClip.RadioClip), typeOf (undefined :: Text.HTML5.MetaData.Schema.TVClip.TVClip)]
