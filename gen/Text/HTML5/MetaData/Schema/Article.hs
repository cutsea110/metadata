...
instance MetaData Article where
  ...
  _subtypes      = const [typeOf (undefined :: Text.HTML5.MetaData.Schema.BlogPosting.BlogPosting), typeOf (undefined :: Text.HTML5.MetaData.Schema.NewsArticle.NewsArticle), typeOf (undefined :: Text.HTML5.MetaData.Schema.ScholarlyArticle.ScholarlyArticle), typeOf (undefined :: Text.HTML5.MetaData.Schema.TechArticle.TechArticle)]
