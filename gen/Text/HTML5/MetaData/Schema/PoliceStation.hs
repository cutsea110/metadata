...
module Text.HTML5.MetaData.Schema.PoliceStation where
...
data PoliceStation = PoliceStation { additionalType :: AdditionalType
...
instance MetaData PoliceStation where
  _label         = const "Police Station"
  _comment_plain = const ""
  _comment       = const ""
  _url           = const "http://schema.org/PoliceStation"
  ...
  _subtypes      = const []
  _supertypes    = const [typeOf (undefined :: Text.HTML5.MetaData.Schema.CivicStructure.CivicStructure), typeOf (undefined :: Text.HTML5.MetaData.Schema.EmergencyService.EmergencyService)]